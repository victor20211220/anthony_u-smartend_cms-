<style type="text/css">
    ...
    .pagination ul > li.active > span, a.thumbnail:hover, input[type="text"].search-form:focus {
        border: 1px solid {{ Helper::GeneralSiteSettings("style_color1") }};
    }
    ...
    .pullquote-right {
        border-right: 5px solid {{ Helper::GeneralSiteSettings("style_color1") }};
    }
    ...
    ul.clients li:hover {
        border: 4px solid {{ Helper::GeneralSiteSettings("style_color1") }};
    }
    ...
    #featured .flexslider .slide-caption {
        border-left: 5px solid {{ Helper::GeneralSiteSettings("style_color1") }};
    }
    ...
    .nivo-caption, .caption {
        border-bottom: {{ Helper::GeneralSiteSettings("style_color1") }} 5px solid;
    }
